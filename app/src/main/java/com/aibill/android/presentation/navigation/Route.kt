...
sealed interface Route {
    ...
    @Serializable data class Transactions(val categoryId: Int? = null, val type: String? = null) : Route
    ...
    @Serializable data class CategoryTransactions(val categoryId: Int, val type: String) : Route
